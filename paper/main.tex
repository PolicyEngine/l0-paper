...
\url{https://github.com/PolicyEngine/l0-python}. The candidate universe used here is a generated
three-year pooled ASEC support artifact from \populace{} commit \texttt{558e46c1}, with base H5 SHA-256
beginning \texttt{ec290055}; the target facts have SHA-256 beginning \texttt{82cd9e87}. The current
