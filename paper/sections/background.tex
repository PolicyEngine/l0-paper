...
sweep (Section~\ref{sec:future_work}). A raking-then-TRS variant is the corresponding classical baseline
...
and one we expect to make a weaker sampler for that reason; Section~\ref{sec:l1_background} develops the
...
an analogous penalty method worth testing directly in future work (Section~\ref{sec:future_work}), where
