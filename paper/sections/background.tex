...
its convex $L_1$ analog, random sampling with reweighting, and survey-weight sampling. Raking-based
reductions, balanced sampling, and combinatorial optimisation remain published comparators that
