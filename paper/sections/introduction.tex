...
sampling and survey-weight sampling at the same record budget, and how does that comparison change as
the budget tightens? Second, does the retained sample generalize, in the sense that it also matches
