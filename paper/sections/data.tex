...
national, state, and district targets. For this build the candidate universe is one row per household:
records are not replicated across alternative geographic placements, so the candidate count is the
household count of 75{,}112.
...
from the current \populace{} US fiscal registry: 37{,}053 Ledger facts produce 31{,}534 targets after
