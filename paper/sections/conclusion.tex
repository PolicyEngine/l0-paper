...
and keeps the reduced dataset calibrated to its targets. We compare the method against random
sampling with reweighting at matched budgets and report how the size, geography, and weight controls
behave.

The contribution is therefore twofold: a target-informed sampling method, and an open pipeline, built
on \microplex{}, that makes the method a configuration choice other projects can reuse. Future work
