...
ax.annotate(
    "",
    xy=(box_x(5) + BOX_W * 0.45, band_y),
    xytext=(box_x(2), band_y),
...
ax.annotate(
    "",
    xy=(box_x(5) + BOX_W, band_y),
    xytext=(box_x(5) + BOX_W * 0.55, band_y),
