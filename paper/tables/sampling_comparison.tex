...
\midrule
Informed $L_0$ & 10{,}000 & \multicolumn{5}{c}{\tbc[from \texttt{expanded-3seed}]} \\
Random + reweight & 10{,}000 & \multicolumn{5}{c}{\tbc[from \texttt{expanded-3seed}]} \\
Survey-weight (Hansen--Hurwitz) & 10{,}000 & \multicolumn{5}{c}{\tbc[from \texttt{expanded-3seed}]} \\
\bottomrule
\end{tabular}
}
}
